...
class EngineStack extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    List<int> oldRVacCount = [0, 1, 2];
    List<int> newRVacCount = [0, 1, 2, 3, 4, 5];
    return isOldDesgin
        ? Stack(
            //OLD
            children: [
              ...
              for (var i in oldRVacCount)
                Raptor(
                  ...
                  path: enginepath + "sea_" + (i + 1).toString() + ".svg",
                  width: width,
                  height: height,
                ),
              ...
              for (var i in oldRVacCount)
                Raptor(
                  ...
                  path: enginepath + "vac_old_" + (i + 1).toString() + ".svg",
                  width: width,
                  height: height,
                ),
            ],
        ...
        : Stack(
            ...
            children: [
              ...
              for (var i in newRVacCount)
                Raptor(
                  display: vacRaptorBooleans[i],
                  path: enginepath + "vac_new_" + (i + 1).toString() + ".svg",
                  width: width,
                  height: height,
                ),
            ],
...
class StarshipPartsDiagram extends StatelessWidget {
  const StarshipPartsDiagram(
      {Key? key, required this.starship, this.width, this.height})
      : super(key: key);
